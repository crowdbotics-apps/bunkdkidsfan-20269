"""bunkdkidsfan_20269 URL Configuration
...
admin.site.site_header = "bunkdkidsfan"
admin.site.site_title = "bunkdkidsfan Admin Portal"
admin.site.index_title = "bunkdkidsfan Admin"

# swagger
api_info = openapi.Info(
    title="bunkdkidsfan API",
    default_version="v1",
    description="API documentation for bunkdkidsfan App",
)
